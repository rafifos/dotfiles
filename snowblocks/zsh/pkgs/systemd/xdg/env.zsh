...
export XDG_CACHE_HOME="${PATH_USER_CACHE:-${XDG_CACHE_HOME:-$HOME/.cache}}"
export XDG_CONFIG_HOME="${PATH_USER_CONFIG:-${XDG_CONFIG_HOME:-$HOME/.config}}"
export XDG_DATA_HOME="${PATH_USER_DATA:-${XDG_DATA_HOME:-$HOME/.local/share}}"
...
# User directories.
export XDG_DESKTOP_DIR=$PATH_USER_DESKTOP
export XDG_DOCUMENTS_DIR=$PATH_USER_DOCUMENTS
export XDG_DOWNLOAD_DIR=$PATH_USER_DOWNLOADS
export XDG_MUSIC_DIR=$PATH_USER_MUSIC
export XDG_PICTURES_DIR=$PATH_USER_IMAGES
export XDG_TEMPLATES_DIR=$PATH_USER_TEMPLATES
export XDG_VIDEOS_DIR=$PATH_USER_VIDEOS
